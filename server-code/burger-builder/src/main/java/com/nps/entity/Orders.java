...
public class Orders {
	  ...
	  // Order Status
	  private static final String CREATE = "CREATE"; // Fresh order
	...
	public int getTotalPrice() {
		return BASE_PRICE + SALAD_PRICE * ingredients.getSalad() + BACON_PRICE * ingredients.getBacon() + CHEESE_PRICE * ingredients.getCheese() + MEAT_PRICE * ingredients.getMeat();
	}
